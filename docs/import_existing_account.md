# Import secureKey in TAG a.k.a import existing ed25519 account in vault

## Overview

This page aims to explain how to import a private key in Vault (transit).
...
However, Vault offers a feature of backup/restore that we will use in this tutorial to import a private key.

##Key Importing Steps
The Tezos account that is going to be imported is:

`{
"publicKey": "edpkunY3jsNhGnP3mkYnWmBTYxqjSii1pyY9oUSkNnix3pNHRTMaAc",
"secretKey": "edskS6oof64x1Uj2ZdDRj8a5WVJmKxDX2VbiPmVJHoydxFQ3eZpLk8mhMvz1Lnozsw1KggcCjfMdYZYN6oPQJh3dRSmeaQ9MEG",
"publicKeyHash": "tz1QdgwqsVV7SmpFPrWjs9B5oBNcj2brzqfG"
}`

The public and private keys are in a Tezos prefixed base58 format. To be imported in Vault, they have to be encoded in base64.

### Convert keys from base58 to base64

I used vault and base58 CLI tools (base58 is downloadable with sudo snap install base58) and the bash commands base64, xxd, and tr.
